                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" class="btn btn-soft-secondary btn-sm" data-toggle="add-more"
                                            ...
                                            </div>' data-target=".qunatity-price">
                                            {{ translate('Add More') }}
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <h5 class="fs-14 fw-600 mb-3 mt-4 pb-3"
                                                    style="border-bottom: 1px dashed #e4e5eb;">{{translate('Refund Note')}}</h5>
                            ...
                            @if (addon_is_activated('gst_system'))
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="hsn_code" value=""
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function checkSKUAvailability(el) {
            ...
            let product_id = null; // New product
