                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="hsn_code" value="{{ $product->hsn_code }}" placeholder="{{translate('HSN Code')}}" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                {{translate('GST Rate (%)')}}
...
<script type="text/javascript">
    ...
    function checkSKUAvailability(el) {
        ...
        $.get('{{ route('seller.wholesale.check_sku_availability') }}', { sku: sku, product_id: product_id }, function(data) {
            if (data.exists) {
