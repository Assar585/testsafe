                                    ...
                                    <td class="text-right">
                                        @can('add_digital_product')
                                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                href="{{route('digitalproducts.edit.admin', ['id' => $product->id, 'lang' => env('DEFAULT_LANGUAGE')])}}"
                                        ...
                                        @can('add_digital_product')
                                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                                data-href="{{route('digitalproducts.destroy.admin', $product->id)}}"
                                        ...
                                        @can('add_digital_product')
                                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                href="{{route('digitalproducts.download.admin', encrypt($product->id))}}"
