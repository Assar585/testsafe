                    ...
                    <ul class="list-inline social colored mb-4">
                        ...
                        @for($i = 0; $i < $max_socials; $i++)
                            @if(!empty($custom_links[$i]) && !empty($custom_images[$i]))
                                <li class="list-inline-item ml-2 mr-2" style="vertical-align: middle;">
                                    <a href="{{ $custom_links[$i] }}" target="_blank"
                                        style="display: inline-block; width: 36px; height: 36px; background-color: #fff; border: 1px solid rgba(255,255,255,0.3); border-radius: 50%; overflow: hidden; vertical-align: middle;">
