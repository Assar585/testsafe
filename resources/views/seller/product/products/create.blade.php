                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-md-3">
                                        ...
                                        <button type="button" class="btn btn-sm btn-soft-primary mt-2" onclick="generateDescriptionAI()">
