                        ...
                        <td class="hide-xl" data-label="Info">
                            ...
                            @if(!$product->draft && !$product->digital)
                                <a href="javascript:void(0)"
                                    onclick='openRightcanvas({{ $product->id }}, "{{ $product->getTranslation('name') }}" )'
                                ...
                                <div class="table-options">
                                    @if($ptoduct_type != 'pos_product_list')
                                        ...
                                        @if(!$product->draft)
                                            <a href="{{ route('product', $product->slug) }}" target="_blank"
                                                ...
                                                <span
                                                    class="fs-14 text-secondary fw-500 pl-10px">{{translate('View Product')}}</span>
                                            </a>
                                        @endif
                                        @if($product->digital)
                                            <a class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue"
                                                href="{{route('seller.digitalproducts.download', encrypt($product->id))}}">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="10.2" height="12"
                                                        viewBox="0 0 10.2 12">
                                                        <path
                                                            d="M 4.6 7.8 L 4.6 1.8 L 5.6 1.8 L 5.6 7.8 L 8.4 7.8 L 5.1 11.1 L 1.8 7.8 L 4.6 7.8 Z M 1.8 10.8 L 8.4 10.8 L 8.4 12 L 1.8 12 L 1.8 10.8 Z"
                                                            fill="#414141" transform="translate(0 -1.8)" />
                                                    </svg>
                                        ...
                                        @else
                                            ...
                                            <a class="d-flex align-items-center px-20px py-10px hov-bg-light hov-text-blue"
                                                ...
                                                <span
                                                    class="fs-14 text-secondary fw-500 pl-10px">{{translate('Make a Clone')}}</span>
                                            </a>
                                        @endif
                                        <!--Delete-->
                                        <a href="javascript:void(0)"
                                    ...
                                    @else
                                        ...
                                        <a href="javascript:void(0)"
                                            ...
                                            onclick="singleRemove({{$product->id}})">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="10.667" height="12"
                                                    viewBox="0 0 10.667 12">
                                                    <path id="Path_45219" data-name="Path 45219"
                                            ...
                                            <span
                                                class="fs-14 text-danger fw-500 pl-5px">{{translate('Remove from POS')}}</span>
                                        </a>
                                    @endif
                                </div>
                            </div>
