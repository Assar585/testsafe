        ...
        <div class="row">
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4">
                ...
                @if (get_setting('show_social_links'))
                    ...
                    <style>
                        /* Reliable Flexbox alignment for all footer social icons */
                        ...
                        .footer-social-container .list-inline-item {
                            margin: 0 !important;
                            padding: 0 !important;
                        }
                        ...
                        /* Standard Glyph icons (Facebook, Instagram, etc) */
                        .footer-social-container a:not(.has-img) {
                            border-radius: 50%;
                            border: 1px solid rgba(255, 255, 255, 0.1);
                        }

                        /* Image-based icons (Custom uploads) - Restore original look */
                        .footer-social-container a.has-img {
                            background-color: transparent !important;
                            border: none !important;
                            border-radius: 0 !important;
                        }

                        .footer-social-container a.has-img img {
                            width: 36px;
                            height: 36px;
                            max-width: 36px;
                            max-height: 36px;
                        ...
                        /* Colors for built-in brands */
                        .footer-social-container a.facebook {
                            background-color: #3b5998;
                        }

                        .footer-social-container a.x-twitter {
                        ...
                        .footer-social-container a.linkedin {
                            background-color: #0077b5;
                        }
                    </style>

                    <ul class="footer-social-container mb-4">
                        ...
                        @if (get_setting('custom_social_links') != null)
                            ...
                            @if (is_array($custom_links) && is_array($custom_images))
                                @php die('UPDATES_FOOTER_MID_315'); @endphp
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="text-center text-sm-left mt-4">
                        ...
                        @if (addon_is_activated('delivery_boy'))
                            <h4 class="fs-14 text-secondary text-uppercase fw-700 mt-4 mb-3">{{ translate('Delivery Boy') }}
                            </h4>
                            <ul class="list-unstyled">
                                @guest
                                    <li class="mb-2">
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col">
            @if (Auth::check())
                ...
                @else
                    <a href="javascript:void(0)" class="text-secondary d-block text-center pb-2 pt-3 mobile-side-nav-thumb"
